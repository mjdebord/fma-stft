...
# Credit for the rest of functions in this file
#
# This file is a reformat of the excellent blog here:
#   https://timsainb.github.io/spectrograms-mfccs-and-inversion-in-python.html
# Extra credits to Kyle Kastner for most of the Spectrograms/Inversion code
#   https://gist.github.com/kastnerkyle/179d6e9a88202ab0a2fe
# Mel filter banks by James Lyons
...
def mel_to_spectrogram(mel_spec, mel_inversion_filter, spec_thresh, shorten_factor):
    ...
    uncompressed_spec = uncompressed_spec - spec_thresh
